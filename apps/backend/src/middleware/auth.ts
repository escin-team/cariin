...
/**
 * Note: Stub authMiddleware saat ini belum membungkus next() dengan withRlsContext.
 * Ketika diupgrade ke JWT real, middleware ini harus melakukan:
 * return withRlsContext({ userId, tenantId }, async () => { ... await next(); });
 * Dan withRlsContext akan dihapus dari service layer.
 */
